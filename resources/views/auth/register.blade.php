...
<body class="flex min-h-screen items-center justify-center bg-red-600 p-4">
    ...
    <div class="w-full max-w-sm rounded-xl bg-white p-8 shadow-2xl">
        ...
        <h2 class="mb-8 text-center text-3xl font-bold">Register</h2>

        {{-- Menampilkan semua error --}}
        @if ($errors->any())
            <div class="mb-4">
                <ul class="list-disc space-y-1 text-sm text-red-600">
        ...
        <form method="POST" action="/register">
            ...
            <div class="mb-5">
                <label for="phone_number" class="mb-1 block text-sm font-medium text-gray-700">
                    Phone Number
                </label>
        ...
        <div class="mt-4 text-center">
            ...
            <a href="/login" class="text-sm font-medium text-red-600 transition duration-150 hover:text-red-800">
                Login
            </a>
        </div>
    </div>
