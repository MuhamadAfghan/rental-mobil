    ...
    <div class="main-content">
        <div class="mx-auto max-w-4xl px-8 py-8">
            ...
            @php
                ...
                {
                    if ($status === 'paid') {
                        return ['label' => 'Sudah Dibayar', 'color' => 'text-green-600'];
                    } elseif ($status === 'unpaid') {
                        return ['label' => 'Belum Dibayar', 'color' => 'text-yellow-600'];
                ...
                function getRentalStatusLabel($rentalStatus)
                {
                    if ($rentalStatus === 'pending') {
                        ...
                        return ['label' => 'Sedang Disewa', 'color' => 'text-purple-600'];
                    } elseif ($rentalStatus === 'completed') {
                        return ['label' => 'Selesai', 'color' => 'text-green-700'];
                ...
                <div class="history-card">
                    ...
                    <div class="mb-4 flex items-center justify-between border-b border-gray-200 pb-4">
                        ...
                        <div class="flex gap-2">
                            <p class="{{ $paymentStatus['color'] }} text-sm font-semibold">{{ $paymentStatus['label'] }}
                            </p>
                            <span class="text-gray-400">|</span>
                            <p class="{{ $rentalStatus['color'] }} text-sm font-semibold">{{ $rentalStatus['label'] }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-8 pt-2 lg:grid-cols-2">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <p
                                    class="{{ $order->with_driver == 1 ? 'text-green-600' : 'text-red-600' }} text-base">
                            ...
                            <div class="border-t border-gray-300 pt-2">
                                ...
                                <p class="text-3xl font-extrabold text-red-700">{{ formatRupiah($order->total_price) }}
                                </p>
                            </div>
                            ...
                            @if ($order->status === 'unpaid')
                                <div class="flex space-x-4 border-t border-gray-300 pt-4">
                                    ...
                                    <form action="/user/rental/{{ $order->id }}/cancel" method="POST"
                                        class="flex-1"
            ...
            @empty
                <div class="py-12 text-center text-gray-500">
                    ...
                    <a href="{{ url('/') }}#menu-mobil"
                        class="mt-2 inline-block text-blue-600 hover:underline">Mulai
                        pesan sekarang!</a>
                </div>
            @endforelse
