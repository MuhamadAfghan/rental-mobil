...
<body class="bg-gray-100">
    ...
    <div class="main-content p-8">
        <h1 class="mb-10 text-4xl font-extrabold text-gray-800">Edit Car</h1>
        ...
        <form action="/admin/edit-car/{{ $car->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-3 gap-8">
                    ...
                    <div class="admin-card">
                        ...
                        <div class="relative">
                            <input type="number" name="price" placeholder="Input Price" required
                                value="{{ old('price', $car->price_per_day) }}"
                                class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-transparent focus:ring-2 focus:ring-red-500">
                ...
                <div class="space-y-6">
                    @php
                        $existingImages = json_decode($car->images);
                    @endphp
                    <div class="admin-card">
                        @if (isset($existingImages[0]))
                            <img src="{{ asset('storage/' . $existingImages[0]) }}" id="preview1"
                        ...
                        <label class="image-upload" for="image1">
                            <div class="text-center">
                                ...
                                <span
                                    class="text-lg text-gray-500">{{ isset($existingImages[0]) ? 'Change Image' : 'Add Image' }}</span>
                            </div>
                        </label>
                    ...
                    <div class="admin-card">
                        @if (isset($existingImages[1]))
                            <img src="{{ asset('storage/' . $existingImages[1]) }}" id="preview2"
                                class="mb-3 h-48 w-full rounded-lg object-cover">
                        @endif
                        <label class="image-upload" for="image2">
                            <div class="text-center">
                                ...
                                <span
                                    class="text-lg text-gray-500">{{ isset($existingImages[1]) ? 'Change Image' : 'Add Image' }}</span>
                            </div>
                        </label>
                    ...
                    <div class="admin-card">
                        @if (isset($existingImages[2]))
                            <img src="{{ asset('storage/' . $existingImages[2]) }}" id="preview3"
                                class="mb-3 h-48 w-full rounded-lg object-cover">
                        @endif
                        <label class="image-upload" for="image3">
                            <div class="text-center">
                                ...
                                <span
                                    class="text-lg text-gray-500">{{ isset($existingImages[2]) ? 'Change Image' : 'Add Image' }}</span>
                            </div>
                        </label>
